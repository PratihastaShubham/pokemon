...
export const metadata: Metadata = {
  ...
  title: {
    default: "Pokémon Reminiscencia – Free Download | Official Site",
  ...
  openGraph: {
    ...
    title: "Pokémon Reminiscencia – Free Download | Official Site",
    description:
      "Download Pokémon Reminiscencia, a beautiful and challenging story-driven roguelike Pokémon fan game for Windows PC.",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Download Pokémon Reminiscencia, a beautiful and challenging story-driven roguelike Pokémon fan game for Windows PC.",
    images: [
      "https://pub-133a3887e9d04fdb98224777e237c4eb.r2.dev/screenies.webp",
    ],
