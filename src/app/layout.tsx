...
export const metadata: Metadata = {
  ...
  title: {
    default: "Pokémon Reminiscencia Download - Official Site",
    template: "%s | Pokémon Reminiscencia"
  },
  description: "Pokémon Reminiscencia is a beautiful, challenging, story-driven roguelike adventure. Download Pokémon Reminiscencia and all the information you need.",
  keywords: [
