...
export default function MiniScenciaDownloadPage() {
    return (
            ...
            >
                ...
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-6 tracking-tight">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600">
                        Pokémon Mini Scencia
                    </span>
                </h1>
                <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                    Get started with your compact Pokémon adventure in just a few clicks!
                </p>
            </motion.section>
            ...
            >
                <div className="glass-card p-8 sm:p-12 rounded-3xl border border-purple-500/30 bg-gradient-to-br from-purple-900/20 to-pink-900/20 max-w-4xl mx-auto">
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-3xl font-bold text-white mb-3">Pokémon Mini Scencia v1.0</h2>
                        <p className="text-gray-400">Latest stable release</p>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-3 gap-4 mb-8">
                        <div className="bg-black/30 p-5 rounded-xl border border-white/10 text-center">
                            ...
                            <p className="text-white font-bold">~50-100 MB</p>
                        </div>
                        <div className="bg-black/30 p-5 rounded-xl border border-white/10 text-center">
                ...
                <div className="max-w-3xl mx-auto space-y-4">
                    {[
                        ...
                        },
                        {
                            ...
                            description: "Start your Pokémon journey and have fun!"
                        }
                    ].map((instruction, idx) => (
                ...
                <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    <div className="glass-card p-8 rounded-2xl border border-green-500/20">
                        ...
                        <ul className="space-y-3 text-gray-300">
                            ...
                            <li className="flex items-start gap-2">
                                <span className="text-green-400">•</span>
                                <span><strong>Memory:</strong> 2 GB RAM</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-green-400">•</span>
                    ...
                    <div className="glass-card p-8 rounded-2xl border border-purple-500/20">
                        ...
                        <ul className="space-y-3 text-gray-300">
                            ...
                            <li className="flex items-start gap-2">
                                <span className="text-purple-400">•</span>
                                <span><strong>Storage:</strong> 500 MB available space</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            >
                ...
                <div className="max-w-3xl mx-auto space-y-4">
                    {[
                        ...
                        {
                            issue: "Missing DLL files error",
                            solution: "Install the latest Microsoft Visual C++ Redistributable package from the official Microsoft website."
                        },
                        {
                        ...
                        {
                            issue: "Game runs too slow",
                            solution: "Close background applications and ensure your system meets the minimum requirements. Try running in compatibility mode for older Windows versions."
                        }
                    ].map((item, idx) => (
